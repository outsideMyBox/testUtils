 ...
 */
public final class ValidBeanLike {
	...
	public ValidBeanLike(String aString, List<String> aListOfString) {
		this.aString = aString;
		this.aListOfString = aListOfString;
	}

	// Change the order of the arguments.
	public ValidBeanLike(List<String> aListOfString, String aString) {
		this.aString = aString;
		this.aListOfString = aListOfString;
	}

	public ValidBeanLike(String aString, List<String> aListOfString, int anInt, Integer anInteger) {
		this.aString = aString;
		this.aListOfString = aListOfString;
		this.anInt = anInt;
	...
	public boolean equals(Object obj) {
		...
		final ValidBeanLike other = (ValidBeanLike) obj;
		if (aBoolean == null) {
