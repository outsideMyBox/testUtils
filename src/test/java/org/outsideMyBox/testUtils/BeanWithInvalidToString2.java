 ...
 */
public final class BeanWithInvalidToString2 {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof BeanWithInvalidToString2)) {
			return false;
		}
		final BeanWithInvalidToString2 other = (BeanWithInvalidToString2) obj;
		if (aBoolean == null) {
	...
	public String toString() {
		// Must return a string dependent on each property.
		return null;
	}
