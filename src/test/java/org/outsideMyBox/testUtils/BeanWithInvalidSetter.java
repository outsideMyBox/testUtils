 ...
 */
public final class BeanWithInvalidSetter {
	...
	// Mustn't return a String.
	public String setAString(String string) {
		aString = string;
		return aString;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof BeanWithInvalidSetter)) {
			return false;
		}
		final BeanWithInvalidSetter other = (BeanWithInvalidSetter) obj;
		if (aBoolean == null) {
